...
class FormEnterName(Form):
    def __init__(self, name, pantalla, x, y, active, level_num, music_path, score: int):
        ...
        self.enter_name_title = TextTitle(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2-265, texto='This or That', pantalla=pantalla, font_size=75)
        ...
        self.confirmation_button = Button(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2+210, texto='CONFIRM', pantalla=pantalla, font_size= 35, on_click=None)
    ...
    def click_confirm_name(self, param: str):
        ...
        print(f'{self.writing_text.texto} - Score: {self.score}')
